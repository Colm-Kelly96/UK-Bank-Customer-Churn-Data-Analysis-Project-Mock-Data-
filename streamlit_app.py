...
st.markdown("**🔥 Key Insight: 9 of the top 10 high-volume churn segments involve customers with only a single product**  \Single-product customers are the biggest driver of churn volume — focusing on them with proactive retention will have the biggest impact")
